...
const Home = () => {
        ...
        experience: '10' },
  {
     _id: '3', 
     name: 'Raghubir',
      specialization: 'MD Pulmonary Medicine',
       rating: '4.7',
        patients: '1100',
         experience: '12' },
  {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div>
              ...
              <p className="text-xl text-blue-100 mb-8">
                Book appointments with India's top doctors instantly. 
