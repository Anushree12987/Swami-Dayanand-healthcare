...
const Header = () => {
  ...
  const navLinks = [
    ...
    { to: '/contact', label: 'Contact', icon: <Phone className="h-4 w-4" /> },
      { to: '/symptom-checker', label: 'SymptomChecker', icon: <FileText className="h-4 w-4" /> },
  ];

  return (
    <header className="bg-gradient-to-r from-white to-blue-50 border-b border-blue-100 shadow-sm sticky top-0 z-50 h-16">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900 tracking-tight">
                Swami Dayanand <span className="text-blue-600">Hospital</span>
              </h1>
