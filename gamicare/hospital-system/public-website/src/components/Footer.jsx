...
const Footer = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      text: 'info@swamidayanandhospital.in',
      href: 'mailto:info@swamidayanandhospital.in'
    },
    {
            ...
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <h2 className="text-2xl font-bold tracking-tight">
                  Swami Dayanand <span className="text-blue-400">Hospital</span>
                </h2>
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="text-center md:text-left">
              <p className="text-gray-400 text-sm">
                © {new Date().getFullYear()} Swami Dayanand Hospital.All rights reserved.
              </p>
            ...
            <div className="text-center md:text-right text-xs text-gray-500">
              <p>Accredited by India Medical Association</p>
