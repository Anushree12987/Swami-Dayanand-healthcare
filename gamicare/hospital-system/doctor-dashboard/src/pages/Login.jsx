      ...
      <div className="max-w-md w-full">
        ...
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-3 mb-4">
            ...
            <div>
              <h1 className="text-3xl font-bold text-white">Swami Dayanand</h1>
        ...
        <div className="mt-8 text-center">
          <p className="text-[#16C79A]/80">
            ...
            <a href="mailto:support@swamidayanandhospital.com" className="text-[#16C79A] hover:text-white font-medium transition-all duration-300">
              Contact Support
            </a>
          </p>
          ...
          <div className="mt-4 pt-4 border-t border-[#16C79A]/20">
            <p className="text-sm text-[#16C79A]/60">
              © {new Date().getFullYear()} 2026 Swami Dayanand Hospital.All rights reserved.
            </p>
        ...
        <div className="mt-6 flex items-center justify-center gap-2 text-sm text-[#16C79A]/60">
          ...
          <span>I Dua Swami Dayanand Hospital</span>
        </div>
      </div>
    </div>
  )
