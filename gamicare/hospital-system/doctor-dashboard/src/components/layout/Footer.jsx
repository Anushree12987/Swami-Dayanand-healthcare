          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                ...
                <a href="tel:+911122581036" className="text-gray-600 hover:text-blue-600 transition-colors"> +91 11 2258 1036</a>
              </li>
              <li className="flex items-center gap-2">
                <Mail className="h-4 w-4 text-blue-600" />
                <a href="mailto:info@sdnhospital.org" className="text-gray-600 hover:text-blue-600 transition-colors">info@sdnhospital.org</a>
              </li>
              <li className="flex items-center gap-2">
            ...
            <div className="mt-4 p-3 bg-red-50 border border-red-200 rounded-lg">
              ...
              <a href="tel:+911122588585" className="text-lg font-bold text-red-600 hover:text-red-700 transition-colors">+91 11 2258 8585</a>
            </div>
          </div>
        </div>
